      ...
      <Paper sx={{ p: 2, bgcolor: "#e3f2fd" }}>
        <Typography variant="caption" color="text.secondary">
          ...
          <Chip
            label="0987654321"
            size="small"
            onClick={() => setPhone("0987654321")}
            sx={{ mr: 1 }}
          />
          <Chip
            label="0123456789"
            size="small"
            onClick={() => setPhone("0123456789")}
            sx={{ mr: 1 }}
          />
          <Chip
            label="abc123"
            size="small"
            onClick={() => setPhone("abc123")}
          />
        </Typography>
      </Paper>
    </Box>
    ...
    >
      ...
      <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap" }}>
        ...
        <Button
          size="small"
          variant="outlined"
          onClick={() => setPassword("MyP@ssw0rd!2024")}
        >
          Very Strong
        </Button>
      </Box>
...
export const FormValidation: React.FC = () => {
  ...
  const result = validateForm(data, {
    ...
    name: [required("Tên là bắt buộc"), minLength(2, "Ít nhất 2 ký tự")],
  });
    ...
    >
      ...
      <Grid container spacing={2}>
        <Grid item xs={6} sm={4}>
          <Paper sx={{ p: 2 }}>
            ...
            <Typography variant="body2">
              <Chip
                label={input && isValidCCCD(input) ? "Valid" : "Invalid"}
                size="small"
                color={input && isValidCCCD(input) ? "success" : "default"}
              />
            </Typography>
          </Paper>
        </Grid>
        <Grid item xs={6} sm={4}>
          <Paper sx={{ p: 2 }}>
            ...
            <Typography variant="body2">
              <Chip
                label={input && isValidTaxId(input) ? "Valid" : "Invalid"}
                size="small"
                color={input && isValidTaxId(input) ? "success" : "default"}
              />
            </Typography>
          </Paper>
        </Grid>
        <Grid item xs={6} sm={4}>
          <Paper sx={{ p: 2 }}>
            ...
            <Typography variant="body2">
              <Chip
                label={input && isValidCreditCard(input) ? "Valid" : "Invalid"}
                size="small"
                color={
                  input && isValidCreditCard(input) ? "success" : "default"
                }
              />
            </Typography>
          </Paper>
        ...
        <Grid item xs={6} sm={4}>
          <Paper sx={{ p: 2 }}>
            ...
            <Typography variant="body2">
              <Chip
                label={input && isValidUrl(input) ? "Valid" : "Invalid"}
                size="small"
                color={input && isValidUrl(input) ? "success" : "default"}
              />
            </Typography>
          </Paper>
        </Grid>
        <Grid item xs={6} sm={4}>
          <Paper sx={{ p: 2 }}>
            ...
            <Typography variant="body2">
              <Chip
                label={input && validateName(input).valid ? "Valid" : "Invalid"}
                size="small"
                color={
                  input && validateName(input).valid ? "success" : "default"
                }
              />
            </Typography>
          </Paper>
      ...
      <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap" }}>
        ...
        <Button
          size="small"
          variant="outlined"
          onClick={() => setInput("4532015112830366")}
        >
          Credit Card
        </Button>
        <Button
