...
const DepartmentCard: React.FC<{ dept: DepartmentCardData }> = ({ dept }) => {
  ...
  return (
    <div
      className={`p-4 rounded-xl bg-surface-card/70 border border-border-subtle/80 hover:border-border-light/60 transition-all flex flex-col justify-between h-full`}
    >
      <div>
    ...
    <div className="p-3 rounded-lg bg-surface-subtle/40 border border-border-subtle/60 hover:border-border-light/40 transition-colors flex items-center justify-between gap-3">
      ...
      <div className="shrink-0">
        {isOngoing ? (
          ...
          <span className="px-2.5 py-1 rounded-full text-[11px] font-medium bg-blue-400/15 text-blue-400 border border-blue-400/30 flex items-center gap-1.5">
